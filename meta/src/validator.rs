...
/// The parsed grammar fro common mistakes:
/// - using Rust keywords
/// - using Pest keywords
/// - duplicate rules
/// - undefined rules
...
/// Validates that the given `definitions` do not contain any undefined rules.å
#[allow(clippy::ptr_arg)]
...
/// It validates the abstract syntax tree for common mistakes:
